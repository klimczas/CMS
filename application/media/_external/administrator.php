...
#inkuludy beda pomocne przy wykonywaniu niektorych opcji
...
#sprawdzamy czy przesylamy inforamcje ktore sa poprawne
if(isset($_POST['addNewPage']))
{
    #sprawdzamy czy kontroler istnieje
	if(!file_exists("../../../".$configs['controller_path'].$_POST['pagename'].".php"))
	{
		...
		if(!$saveController || !$saveView) #jezeli co najmniej jedno sie nie wykonało
        {
...
#usuwanie strony oraz katalogu z tym widokiem
