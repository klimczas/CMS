    ...
    <div class="wrapright">
	    ...
	    <div id="colRight">
            ...
            <div class="customTable _m5 _fLeft">
	            <div class="tableTitle">Lista artykułów</div>
	            <div class="tableContent">
	                <p><?=model_load("articlesmodel", "drawArticlesList", "")?></p> 
	            </div>
	            <div class="tableActionButtons"></div>
	        </div>
            
            <div class="customLinkBtn _m5 _fLeft"><a href="administrator/articles/view">+ DODAJ NOWY</a></div>
