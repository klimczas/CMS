    ...
    <div class="wrapright">
	    ...
	    <div id="colRight">
            ...
            <div class="customTable _m5 _fLeft">
                <div class="tableTitle">Tytuł artykułu</div>
                <div class="tableContent">
                    <input type="text" id="artTitle" class="customInput _mt10 _w300" name="pageTitle" value="<?=model_load('articles_viewmodel', 'getTitle')?>" />
                </div>
            ...
            <div class="customTable _m5 _fLeft">
                ...
                <div class="tableContent">
                    <input type="text" id="artDate" class="customInput _mt10 _w300" name="pageTitle" value="<?=model_load('articles_viewmodel', 'getDate')?>" />
                </div>
                <div class="tableActionButtons"></div>
            </div>
            ...
            <div class="customTable _m5 _fLeft">
                ...
                <div class="tableContent">
                    <input type="text" id="artAuthor" class="customInput _mt10 _w300" name="pageTitle" value="<?=model_load('articles_viewmodel', 'getAuthor')?>" />
                </div>
                <div class="tableActionButtons"></div>
            </div>
            ...
            <textarea cols="100" id="editor1" name="editor1" rows="90"><?=model_load('articles_viewmodel', 'getText')?></textarea>
            <?=add_javascript(directory_javascript()."administrator/main.articles.js")?>
            
            <br />
            <div id="customLinkBtn" class="_m5 _fLeft"><a href="javascript:void(0);" onclick="saveArticle('<?=model_load('articles_viewmodel', 'getId')?>');">Zapisz zmiany</a></div>
            <br class="_cb" />
