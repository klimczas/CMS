...
class przypomnienie_haslamodel
{
	...
	#metoda sprawdza czy istnieje dany użytkownik po mailu i loginie
	...
	#sprawdza i zwraca true lub false czy any uzytkownik istnieje
	...
	#zmiana hasla (resetowanie hasla i wyslanie go na skrzynke pocztowa)
	public function getContent()
	{
		...
		if(isset($this->__params['POST']['nick']))
		{
			...
			{
				$signs = array('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 1, 2, 3, 4, 5, 6, 7, 8, 9, 0, '@', '#', '$', '%', '&', '*'); #generowanie nowego hasla
				
				$newPw = "";
				
				for($i = 0; $i <= 8; $i++)
				{
					$newPw .= $signs[rand(0, count($signs)-1)]; #nowe haslo
				}
