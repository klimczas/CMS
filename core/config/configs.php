...
if(!defined('DS')) define('DS', '/'); #sprawdza czy stala nie zostala wczejniej zdefiniowana (separator / )
...
$configs['no_lang_error_text'] = "Brak dostępnego tłumaczenia";   #jeśli nie ma tlumaczenia wyświetli brak dosepnego tlumaczenia
$configs['default_meta_tags_index'] = "default"; #identyfikacja konkretnego użytkowika w sesji
...
$configs['db_user'] = "eduweb";
$configs['db_pass'] = "eduweb";
