...
class sgException
{
	...
	public function __set($name, $value) #pobranie wartosci
	{
		$this->$name = $value;
	}
	...
	protected function _send_exception() #wysyla error na podany adres
	{
	...
	public function errorPage($codename = 404)
	{
		...
		{
			$this->throwException("Nie znaleziono pliku błędu!"); #wyrzuca blad jesli nie znaleziono strony
		}
		else
		{
